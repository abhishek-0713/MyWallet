...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorDetails> mywalletExceptionHandler(InsufficientFundException fundException,WebRequest request){
		
		ErrorDetails errorDetails = new ErrorDetails(LocalDateTime.now(), fundException.getMessage(), request.getDescription(false));
